...
namespace SpaceTrack.Services
{
    public class TLEService : ITLEService
    {
...

        {
            ...
            string payloadQueryUrl = "https://www.space-track.org/basicspacedata/query/class/tle_latest/OBJECT_TYPE/PAYLOAD/DECAYED/NULL%20/orderby/ORDINAL%20asc/format/tle/emptyresult/show";
            ...
            for (int i = 0; i < firstLines.Count; i++)
            {
                if (!string.IsNullOrEmpty(firstLines[i]) && !string.IsNullOrEmpty(secondLines[i]))
                {
                    ...
                    // string payloadQueryUrl = "https://www.space-track.org/basicspacedata/query/class/tle_latest/OBJECT_TYPE/PAYLOAD/orderby/ORDINAL%20asc/limit/20000/format/tle/emptyresult/show";
        ...
        public async Task SaveOrUpdateAllDebrisTLEsAsync()
        {
            ...
            //string debrisQueryUrl = "https://www.space-track.org/basicspacedata/query/class/tle_latest/OBJECT_TYPE/DEBRIS/orderby/ORDINAL%20asc/limit/15000/format/tle/emptyresult/show";
            string debrisQueryUrl = "https://www.space-track.org/basicspacedata/query/class/tle_latest/OBJECT_TYPE/DEBRIS/DECAYED/NULL%20/orderby/ORDINAL%20asc/limit/19000/format/tle/emptyresult/show";
        ...
        {
            string RocketsQueryUrl = "https://www.space-track.org/basicspacedata/query/class/tle_latest/OBJECT_TYPE/ROCKET%20BODY/DECAYED/NULL%20/orderby/ORDINAL%20asc/limit/9000/format/tle/emptyresult/show";
        ...
        {
            string UnknownObjectQueryUrl = "https://www.space-track.org/basicspacedata/query/class/tle_latest/OBJECT_TYPE/UNKNOWN/DECAYED/NULL%20/orderby/ORDINAL%20asc/limit/7000/format/tle/emptyresult/show";
        ...
        //public async Task SaveOrUpdateNonePayloadsTLEsAsync()

        //{

        //    string payloadQueryUrl = "";
        //    // Fetch all payload TLE data
        //    var (firstLines, secondLines) = await _spaceTrack.GetAllTLEDataAsync(payloadQueryUrl);
        ...
        //            var tle = new TLENoneActivePayloads
        //            {
        //                NoradId = noradId,
        //                FirstLine = firstLines[i],
        //                SecondLine = secondLines[i],
        ...
        //            // Check if the TLE data already exists in the database
        //            var existingTLE = _context.TLENoneActivePAYLOADS.Find(t => t.NoradId == tle.NoradId).FirstOrDefault();

        //            if (existingTLE != null)
        //            {
        //                // Update the existing TLE document
        //                var updateDefinition = Builders<TLENoneActivePayloads>.Update
        //                    .Set(t => t.FirstLine, tle.FirstLine)
        //                    .Set(t => t.SecondLine, tle.SecondLine)
        //                    .Set(t => t.Timestamp, tle.Timestamp);
        //                //.Set(t => t.ObjectName, tle.ObjectName)

        //                await _context.TLENoneActivePAYLOADS.UpdateOneAsync(t => t.NoradId == tle.NoradId, updateDefinition);
        //            }
        //            else
        //            {
        //                // Insert a new TLE document
        //                await _context.TLENoneActivePAYLOADS.InsertOneAsync(tle);
        //            }
        //        }
        //    }
        //}
