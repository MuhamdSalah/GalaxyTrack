...
namespace SpaceAPI.Controllers
{
    ...
    {
        //        private readonly IMongoCollection<Satel_lite> _satelliteCollection;
        ...
        //            // Query MongoDB
        //            var filter = Builders<Satel_lite>.Filter.Or(
        //                Builders<Satel_lite>.Filter.Eq(s => s.NoardId, noardId),
        //                Builders<Satel_lite>.Filter.Eq(s => s.Name, name)
        //            );
